...
public class ExcelUtil {
    ...
    public synchronized static Recordset GetTestData(String module, String testId) throws Exception {
        try {
        	...
        	TestBase.log.info("Error in test data reading");
        	//TestBase.log.info("Error in test data reading");
    ...
    public synchronized static void GetUserData() throws Exception {
        ...
        try {
            ...
            while (recordset.next()) {
            	if(!recordset.getField("Browser").isEmpty()) {
            ...
            GlobalTestData.CurrentBrowser=browser;
            ...
            while (recordset.next()) {
                if (recordset.getField("Role").equalsIgnoreCase("Requester1")) {
                    //Get data from Excel and Set for Requester_Admin object
                    GlobalTestData.Requester1.setRole(recordset.getField("Role"));
                    GlobalTestData.Requester1.setLoginID(recordset.getField("LoginID"));
                    GlobalTestData.Requester1.setPassword(recordset.getField("Password"));
                    GlobalTestData.Requester1.setDescription(recordset.getField("Description"));
                    
                }else if (recordset.getField("Role").equalsIgnoreCase("HOS")) {
                    //Get data from Excel and Set for Requester_Admin object
                    GlobalTestData.HOS.setRole(recordset.getField("Role"));
                    GlobalTestData.HOS.setLoginID(recordset.getField("LoginID"));
                    GlobalTestData.HOS.setPassword(recordset.getField("Password"));
                    GlobalTestData.HOS.setDescription(recordset.getField("Description"));
                	
                }else if (recordset.getField("Role").equalsIgnoreCase("Selection")) {
                    //Get data from Excel and Set for Requester_Admin object
                    GlobalTestData.Selection.setRole(recordset.getField("Role"));
                    GlobalTestData.Selection.setLoginID(recordset.getField("LoginID"));
                    GlobalTestData.Selection.setPassword(recordset.getField("Password"));
                    GlobalTestData.Selection.setDescription(recordset.getField("Description"));
                	
                }else if (recordset.getField("Role").equalsIgnoreCase("Requester2")) {
                    //Get data from Excel and Set for Requester_Admin object
                    GlobalTestData.Requester2.setRole(recordset.getField("Role"));
                    GlobalTestData.Requester2.setLoginID(recordset.getField("LoginID"));
                    GlobalTestData.Requester2.setPassword(recordset.getField("Password"));
                    GlobalTestData.Requester2.setDescription(recordset.getField("Description"));
            ...
            TestBase.log.info("Error in user test data reading");
   ...
   /* *//**
    ...
    public static List<TestConfig> GetTestSuite() throws Exception {
        ...
        try {
            String FS = File.separator;
            String testDataFilePath = "src" + FS + "test" + FS + "resources" + FS + "SuiteControl" + FS + "TestSelection.xlsx";
            File f = new File(testDataFilePath);
            Connection connection = fillo.getConnection(f.getAbsolutePath());
